...
int adventurerEffect(int drawntreasure, int currentPlayer, int temphand[], int z, struct gameState *state) 
{
  int cardDrawn;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return adventurerEffect(drawntreasure, currentPlayer, temphand, z, state);
      ...
      else if (choice2)   //discard hand, redraw 4, other players with 5+ cards discard hand and draw 4
  {
    ...
    case steward:
      return stewardEffect(currentPlayer, choice1, choice2, choice3, handPos, state);
